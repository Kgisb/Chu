...
def _render_performance_cash_in():
    ...
    Layout:
      - First table (Cash-in Summary): range A1:BB13 (stacked on top)
      - Second table (Cash-in Totals): range A15:D15 (shown below)
    """
    import streamlit as st
    import pandas as pd
    ...
    try:
        ...
        # Give friendly column names if the range is a single-row KPI block

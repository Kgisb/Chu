...
def _render_marketing_super_report(df):
    ...
    # Calibration Done Date parsed
    if "done_col" in locals() and done_col:
        work["_done"] = _to_dt(work[done_col])
    else:
        work["_done"] = pd.NaT
    ...
    for g, sub in work.groupby("_grp"):
        ...
        # Calibration done count (based on Calibration Done Date)

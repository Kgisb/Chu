...
def _render_marketing_super_report(df):
    ...
    # Self-book signal: at least one of First Cal / Cal Reschedule present
    has_self_signal = (pd.notna(fcal_dt)) | (pd.notna(rcal_dt))

    # Booking type classification
    is_self = (~is_pre) & has_self_signal
    ...
    with c2:
        ...
        sel_bt = st.multiselect(
            ...
            help="Pre-book = Slot filled; Self-book = no slot & Cal/Resched exists; Unknown = others."
        )

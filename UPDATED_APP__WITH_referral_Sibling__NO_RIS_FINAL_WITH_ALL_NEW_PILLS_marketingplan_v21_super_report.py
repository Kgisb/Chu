...
def _render_marketing_super_report(df):
    ...
    # Prepare common date fields on a working copy
    ...
    def _run_window(label: str, key_prefix: str):
    ...
    with col_a:
        agg_a = _run_window("A", "A")
    with col_b:
        agg_b = _run_window("B", "B")

    # Combined comparison table if both windows have results
